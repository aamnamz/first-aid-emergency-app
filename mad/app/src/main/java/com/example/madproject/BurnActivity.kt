...
class BurnActivity : AppCompatActivity(), OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_burn) // Reference to your Burn layout
    ...
    private fun setupTtsListener() {
        tts.setOnUtteranceProgressListener(object : UtteranceProgressListener() {
            private val UTTERANCE_ID = "burnInstructions"
            ...
            override fun onError(utteranceId: String?) {
                if (utteranceId == UTTERANCE_ID) {
                    runOnUiThread {
                        btnSpeak.text = SPEAK_TEXT
                        Log.e("TTS", "Speech error in BurnActivity.")
                    }
                }
            }
            ...
            override fun onStop(utteranceId: String?, interrupted: Boolean) {
                runOnUiThread {
                    btnSpeak.text = SPEAK_TEXT
                    Log.d("TTS", "Speech stopped by user interaction in BurnActivity.")
                }
            }
        })
    }
    ...
    override fun onInit(status: Int) {
        if (status == TextToSpeech.SUCCESS) {
            ...
            if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
                Log.e("TTS", "Language is not supported or missing data in BurnActivity.")
                ...
                Log.d("TTS", "TTS Initialization successful in BurnActivity.")
            }
        } else {
            Log.e("TTS", "Initialization failed in BurnActivity.")
    ...
    private fun speakOut(text: String) {
        tts.speak(text, TextToSpeech.QUEUE_FLUSH, null, "burnInstructions")
    }
